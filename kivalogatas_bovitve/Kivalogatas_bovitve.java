 ...
 * @author moric
 */
public class Kivalogatas_bovitve {

    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) {
        System.out.println("\n\tKIVÁLOGATÁS TÉTEL KIBŐVÍTVE,Készítette:Móricz János Milán 113C\n");
       
        
        Scanner bemenet=new Scanner(System.in);
        System.out.print("Írja be, hogy hány jegyet szeretne generálni ");
